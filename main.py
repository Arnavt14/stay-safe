...
def model():
    ...
    _2classes = os.listdir(r"C:\\Users\tyagi\Downloads\fight-detection-surv-dataset-master")
    ...
    for counter, i in enumerate(random_range, 1):
        ...
        video_files_names_list = os.listdir(fr'C:\Users\tyagi\Downloads\fight-detection-surv-dataset-master/{selected_class_Name}')
    ...
    DATASET_DIR = r"C:\Users\tyagi\Downloads\fight-detection-surv-dataset-master"
...
if choice == "Signup":
    ...
    if Login:
        ...
        st.title("Carma")
        # Navigation Pane
        st.button("Add File", on_click=model())
    with st.sidebar:
